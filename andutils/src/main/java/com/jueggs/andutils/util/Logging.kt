...
fun logDebug(text: Any?, prefix: String = "") = logTagged(TAG_DEBUG, LOG_LEVEL_DEBUG, text, prefix)

fun logError(text: Any?, prefix: String = "") = logTagged(TAG_ERROR, LOG_LEVEL_ERROR, text, prefix)

fun logNetwork(text: Any?, prefix: String = "") = logTagged(TAG_NETWORK, LOG_LEVEL_DEBUG, text, prefix)
